export const PYTH_FEEDS: Record<string, string> = {
  // Crypto — verified working feed IDs
  ...
  // Pyth Pro — Commodities (correct verified IDs)
  ...
  WTI_USD: '0x925ca92ff005ae943c158e3563f59698ce7e75c5a8c8dd43303a0a154887b3e6',
}
...
export const ASSET_META: Record<string, AssetMeta> = {
  ...
  ARB:     { name:'Arbitrum',      symbol:'ARB/USD',   icon:'▣', iconBg:'rgba(18,170,255,0.15)',  iconColor:'#12aaff', category:'crypto',    isPro:false, decimals:4, baselineConfPct:0.0020 },
  OP:      { name:'Optimism',      symbol:'OP/USD',    icon:'◉', iconBg:'rgba(255,4,32,0.15)',    iconColor:'#ff0420', category:'crypto',    isPro:false, decimals:4, baselineConfPct:0.0020 },
...
// Comprehensive keyword map — catches everything
export const KEYWORD_MAP: Record<string, string> = {
  // BTC
  'bitcoin': 'BTC', 'btc': 'BTC', 'satoshi': 'BTC', 'sats': 'BTC',
  // ETH
  'ethereum': 'ETH', 'eth': 'ETH', 'ether': 'ETH', 'evm': 'ETH',
  // SOL
  'solana': 'SOL', 'sol': 'SOL',
  // AVAX
  ...
  'optimism': 'OP', ' op ': 'OP',
  // SPX
  's&p': 'SPX', 'sp500': 'SPX', 'spx': 'SPX', 's&p 500': 'SPX',
  'sp 500': 'SPX', 'snp': 'SPX', 's and p': 'SPX',
  // TSLA
  ...
  // EUR/USD
  'euro': 'EUR_USD', 'eur': 'EUR_USD', 'eurusd': 'EUR_USD',
  'eur/usd': 'EUR_USD', 'eur usd': 'EUR_USD',
  // GBP/USD
  'pound': 'GBP_USD', 'gbp': 'GBP_USD', 'gbp/usd': 'GBP_USD',
  'sterling': 'GBP_USD', 'british pound': 'GBP_USD',
  // USD/JPY
  'yen': 'USD_JPY', 'jpy': 'USD_JPY', 'usd/jpy': 'USD_JPY',
  'usdjpy': 'USD_JPY', 'japanese yen': 'USD_JPY',
  // Gold
  'gold': 'XAU_USD', 'xau': 'XAU_USD', 'xau/usd': 'XAU_USD',
  // Silver
  'silver': 'XAG_USD', 'xag': 'XAG_USD',
  // Oil
  'oil': 'WTI_USD', 'wti': 'WTI_USD', 'crude': 'WTI_USD',
  'petroleum': 'WTI_USD', 'crude oil': 'WTI_USD', 'brent': 'WTI_USD',
}
